...
jgrep - grep-like utility written in Java

=head1 SYNOPSIS

B<jgrep> I<[OPTIONS]> B<PATTERN> I<[FILES...]>

=head1 DESCRIPTION

B<jgrep> searches for I<PATTERN> in each I<FILE> or standard
...
=item I<JGREP_COLOR> and I<GREP_COLOR>
...
=item I<JGREP_JAVA_OPTS>

Options passed to java(1).

=item I<JGREP_JNI_DIR>

Directory with jgrep_jni library.

=item I<JGREP_NO_JNI>

If set, I<jgrep_jni> library is not loaded.
...
L<https://github.com/cheusov/jgrep>
